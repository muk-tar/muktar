    ...
    return (
        <div className="affiliates">
           ...
           <div className="affiliates-container">
                ...
                <Card15 title="MARQUES" photo={photo5} lin="" flag={ukFlag} description="Premises automation and IoT based energy delivery and management systems for homes, offices, warehouses, factories, shops, malls, apartments, communities, municipalities. etc; redefining electrical wiring." />
