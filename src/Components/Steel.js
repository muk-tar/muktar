...
{/* <div className="container">
                <div className="cardd">
                    <div className="imgBox"><img src={photo} alt=""/></div>
                    <div className="content">
                        <h1>Title</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Asperiores tenetur libero repellendus, earum ea nulla ratione omnis nam impedit incidunt!</p>
                    </div>
                </div>
